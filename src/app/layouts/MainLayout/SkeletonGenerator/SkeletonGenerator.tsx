...
import { TaskEditPageSkeleton } from '@/pages/admin/task/taskEdit';
...
const SkeletonGenerator = () => {
	...
	const isTaskEditPage = matchPath(ROUTES.admin.tasks.edit.page, location.pathname);
