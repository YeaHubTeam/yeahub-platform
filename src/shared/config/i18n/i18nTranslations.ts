...
export enum Task {
	...
	TABLE_TASK_TITLE = 'table.task.title',
	TABLE_DIFFICULTY_TITLE = 'table.difficulty.title',
	TABLE_STATUS_TITLE = 'table.status.title',
	...
	STUB_EMPTY_TASK_PUBLIC_TITLE = 'stub.empty.task.public.title',
	STUB_EMPTY_TASK_PUBLIC_SUBTITLE = 'stub.empty.task.public.subtitle',
	STUB_EMPTY_TASK_PUBLIC_SUBMIT = 'stub.empty.task.public.submit',
