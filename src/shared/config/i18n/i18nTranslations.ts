...
export enum Interview {
	...
	SUCCESS_START_INTERVIEW = 'preparation.toast.successStart',
	ERROR_START_INTERVIEW = 'preparation.toast.errorStart',
	...
	QUESTIONS_TOAST_QUESTIONISNOTLEARNED = 'questions.toast.questionIsNotLearned',
	QUESTIONS_TOAST_PROGRESSISRESET = 'questions.toast.progressIsReset',
	QUESTIONS_TOAST_PROGRESSISNOTRESET = 'questions.toast.progressIsNotReset',
