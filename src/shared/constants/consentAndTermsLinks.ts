export const REGISTRATION_CONSENT_LINK =
...
export const AD_CONSENT_LINK =
	'https://docs.google.com/document/d/1SaCHcZZhb9da-yOePEur3wv2C47ie2R8rPnkkxrxPqA/edit?tab=t.0';

export const OFFER_AGREEMENT_LINK =
