...
export { SpecializationsListField } from '@/entities/specialization/ui/SpecializationsListField/SpecializationsListField';
export { SpecializationsListFieldSkeleton } from '@/entities/specialization/ui/SpecializationsListField/SpecializationsListField.skeleton';
