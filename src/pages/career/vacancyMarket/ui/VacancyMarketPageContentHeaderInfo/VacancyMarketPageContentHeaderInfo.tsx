...
import styles from './VacancyMarketPageContentHeaderInfo.module.css';

interface VacancyMarketPageContentHeaderInfoProps {
	updatedAt: VacancyMarketOverview['updatedAt'];
	isMobile: boolean;
}

export const VacancyMarketPageContentHeaderInfo = ({
	updatedAt,
	isMobile,
}: VacancyMarketPageContentHeaderInfoProps) => {
