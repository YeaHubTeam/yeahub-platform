...
import type { ChallengeWorkspaceProps } from '../model/types/types';

import { ChallengeEditor } from './ChallengeEditor/ChallengeEditor';
import { ChallengeOutput } from './ChallengeOutput/ChallengeOutput';
import styles from './ChallengeWorkspace.module.css';

export const ChallengeWorkspace: FC<ChallengeWorkspaceProps> = ({
	code,
	languageId,
	supportedLanguages,
	isExecuting,
